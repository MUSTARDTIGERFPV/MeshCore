...
On 1.17.1.5, use the repeater's remote admin CLI, or its USB terminal before
it disappears:
...
The second command should return `off`. This saves the setting and takes
...
power saving is enabled, logging is off, and no native USB host is attached.
