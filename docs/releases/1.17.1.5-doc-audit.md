...
- Documented the power-saving guards present at audit time; current instructions
  now use the shared `get powersaving` / `set powersaving on|off` command set.
  Corrected the RS232 baud range and SNMP environment list.
